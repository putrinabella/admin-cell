              ...
              <div class="card card-plain">
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <!-- <a href="#" class="text-primary text-gradient font-weight-bold" data-bs-toggle="modal" data-bs-target="#inlineForm">Sign up</a> -->
                    <a href="<?= base_url('public/login/register'); ?>" class="text-info text-gradient font-weight-bold">Sign up</a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('<?= base_url(); ?>/public/assets/images/Login.jpeg');
          background-size: cover;">
                <span class="mask bg-gradient-primary opacity-6"></span>
                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Daily Reminder"</h4>
                <p class="text-white position-relative">Smile, drink your water, remember why you started spread love and positivity</p>
                <!-- </br>
                </br>
                <p class="text-white position-relative">Nama: Putri Nabela</p>
                <p class="text-white position-relative">NIM : 2011016220026</p> -->
