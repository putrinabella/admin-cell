    ...
    <section class="section">
        <div class="card">
            <div class="card-header pb-0 d-flex justify-content-between ">
                ...
                <a href="#" class="btn icon icon-left btn-primary" data-bs-toggle="modal" data-bs-target="#inlineForm"><i data-feather="edit"></i> Tambah Kategori</a>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#myTable').DataTable({
                ...
                // lengthChange: false,
                ajax: {
                    url: '<?= base_url('public/Home/dataKategori'); ?>',
                    type: 'POST'
                },
                columns: [{
                        data: 'idKategori'
        ...
        function js_hapus(id) {
            ...
            $.ajax({
                    method: "POST",
                    url: "<?= base_url('public/Home/hapusKategori'); ?>",
                    data: {
                        id: id_delete
                    },
                    dataType: "json"
        ...
        function simpan() {
            ...
            $.ajax({
                    method: "POST",
                    url: "<?= base_url('public/Home/simpanKategori'); ?>",
                    data: data_input,
                    dataType: "json"
                })
                .done(function(res) {
