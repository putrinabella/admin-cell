    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#myTable').DataTable({
                ...
                // lengthChange: false,
                ajax: {
                    url: '<?= base_url('public/Jenis/data'); ?>',
                    type: 'POST'
                },
                columns: [{
                        data: 'idBarang'
        ...
        function js_hapus(id) {
            ...
            $.ajax({
                    method: "POST",
                    url: "<?= base_url('public/Jenis/hapusData'); ?>",
                    data: {
                        id: id_delete
                    },
                    dataType: "json"
        ...
        function simpan() {
            ...
            $.ajax({
                    method: "POST",
                    url: "<?= base_url('public/Jenis/simpan'); ?>",
                    data: data_input,
                    dataType: "json"
                })
                .done(function(res) {
                ...
                <div class="modal-body">
                    <form id="form-simpan">
                        ...
                        <select id="idJenis" name="idJenis" class="form-control">
                            <?php foreach ($jenisM as $key => $value) : ?>
                                <option value="<?= $value->idJenis ?>"><?= $value->jenisBarang ?> </option>
                            <?php endforeach; ?>
                        </select>
