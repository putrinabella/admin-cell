...
<title>Myers-Briggs Type Indicator - Mazer Admin Dashboard</title>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header pb-0 d-flex justify-content-between ">
                ...
                <a href="#" class="btn icon icon-left btn-primary" data-bs-toggle="modal" data-bs-target="#inlineForm"><i data-feather="edit"></i> Add Question</a>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#myTable').DataTable({
                ...
                lengthChange: false,
                ajax: {
                    url: '<?= base_url('public/Home/dataMbti'); ?>',
                    type: 'POST'
                },
                columns: [{
                        data: 'idPertanyaan'
        ...
        function js_hapus(id) {
            ...
            $.ajax({
                    method: "POST",
                    url: "<?= base_url('public/Home/hapusmbti'); ?>",
                    data: {
                        id: id_delete
                    },
                    dataType: "json"
        ...
        function simpan() {
            ...
            $.ajax({
                    method: "POST",
                    url: "<?= base_url('public/Home/simpanmbti'); ?>",
                    data: data_input,
                    dataType: "json"
                })
                .done(function(res) {
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">Insert Question </h4>
                ...
                <div class="modal-body">
                    <form id="form-simpan">
                        <label>No. </label>
                        <input type="text" class="form-control" id="idPertanyaan" name="idPertanyaan">
